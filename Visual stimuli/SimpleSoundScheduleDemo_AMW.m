...
beep1 = MakeBeep(220, 1, freq);
beep2 = MakeBeep(440, 1, freq);
beep3 = MakeBeep(880, 1, freq);

buffer = [];
buffer(end+1) = PsychPortAudio('CreateBuffer', pahandle, beep1);
buffer(end+1) = PsychPortAudio('CreateBuffer', pahandle, beep2);
buffer(end+1) = PsychPortAudio('CreateBuffer', pahandle, beep3);
...
PsychPortAudio('AddToSchedule', pahandle, 1);
...
PsychPortAudio('AddToSchedule', pahandle, 2);
...
for trial = 1:1
    ...
    startTime = PsychPortAudio('Start', pahandle, [], triggerTime,1);
