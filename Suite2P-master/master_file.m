...
addpath('/Users/Aaron/Documents/MATLAB/GeffenCode/Suite2P-master/configFiles'); % add the path to your make_db file
...
ops0.toolbox_path = '/Users/Aaron/Documents/MATLAB/GeffenCode/Suite2P-master';
...
ops0.RootStorage            = '/Volumes/AARON FILES/Test Kath folder/'; % Suite2P assumes a folder structure, check out README file
ops0.temp_tiff              = '/Volumes/AARON FILES/Test Kath folder/temp.tif'; % copies each remote tiff locally first, into this file
ops0.RegFileRoot            = '/Volumes/AARON FILES/Test Kath folder/';  % location for binary file
ops0.DeleteBin              = 1; % set to 1 for batch processing on a limited hard drive
ops0.ResultsSavePath        = '/Volumes/AARON FILES/Test Kath folder/'; % a folder structure is created inside
