...
stimPath = fullfile('D:\Electrophysiology\',experiment,mouseID,date,'StimInfo',[date '_' mouseID '_AVloomingComplexTones_exptInfo']);
...
newDir = fullfile('D:\Electrophysiology\',experiment,mouseID,date,'AVLoomingComplexResponses');
