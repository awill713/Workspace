...
stimPath = fullfile('E:\Electrophysiology\',experiment,mouseID,date,'StimInfo',[date '_' mouseID '_AVloomingComplexTones_stimInfo10000']);
...
dataFiles = dir(fullfile(dataFolder,'*AV_looming_complexTones10000-*'));

% newDir = fullfile('D:\KiloSort\',mouseID,session,folder,'OptoNoiseResponses');
newDir = fullfile('E:\Electrophysiology\',experiment,mouseID,date,'AVLoomingComplexResponses10000');
