...
stimPath = fullfile('E:\Electrophysiology\',experiment,mouseID,date,'StimInfo',[date '_' mouseID '_AVloomingWhiteNoise_stimInfo3050']);
...
dataFiles = dir(fullfile(dataFolder,'*AV_looming_whiteNoise3050*'));

% newDir = fullfile('D:\KiloSort\',mouseID,session,folder,'OptoNoiseResponses');
newDir = fullfile('E:\Electrophysiology\',experiment,mouseID,date,'AVLoomingWhiteNoiseResponses_30-50dB');
